class ApplyWorkspaceEditParams {
  ...
  factory ApplyWorkspaceEditParams.fromJson(Map params) =>
      new ApplyWorkspaceEditParams._(
          params != null && params.containsKey('edit')
              ? new WorkspaceEdit.fromJson(params['edit'])
              : null,
          params != null && params.containsKey('label')
              ? params['label']
              : null);
...
class ClientCapabilities {
  ...
  factory ClientCapabilities.fromJson(Map params) => new ClientCapabilities._(
      params != null && params.containsKey('textDocument')
          ? new TextDocumentClientCapabilities.fromJson(params['textDocument'])
          : null,
      params != null && params.containsKey('workspace')
...
class CodeActionContext {
  ...
  factory CodeActionContext.fromJson(Map params) => new CodeActionContext._(
      params != null && params.containsKey('diagnostics')
          ? params['diagnostics']
...
class CodeLensOptions {
  ...
  factory CodeLensOptions.fromJson(Map params) => new CodeLensOptions._(
      params != null && params.containsKey('resolveProvider')
...
class Command {
  ...
  factory Command.fromJson(Map params) => new Command._(
      params != null && params.containsKey('arguments')
          ? params['arguments']
          : null,
      params != null && params.containsKey('command')
          ? params['command']
          : null,
      params != null && params.containsKey('title') ? params['title'] : null);
...
class CompletionCapabilities {
  ...
  factory CompletionCapabilities.fromJson(Map params) =>
      new CompletionCapabilities._(
          params != null && params.containsKey('completionItem')
              ? new CompletionItemCapabilities.fromJson(
                  params['completionItem'])
              : null,
          params != null && params.containsKey('dynamicRegistration')
...
class CompletionItem {
  ...
  factory CompletionItem.fromJson(Map params) => new CompletionItem._(
      params != null && params.containsKey('additionalTextEdits')
      ...
      params != null && params.containsKey('command')
          ...
          : null,
      params != null && params.containsKey('data') ? params['data'] : null,
      params != null && params.containsKey('detail') ? params['detail'] : null,
      params != null && params.containsKey('documentation')
          ? params['documentation']
          : null,
      params != null && params.containsKey('filterText')
          ? params['filterText']
          : null,
      params != null && params.containsKey('insertText')
          ? params['insertText']
          : null,
      params != null && params.containsKey('insertTextFormat')
          ? new InsertTextFormat.fromJson(params['insertTextFormat'])
          : null,
      params != null && params.containsKey('kind')
          ? new CompletionItemKind.fromJson(params['kind'])
          : null,
      params != null && params.containsKey('label') ? params['label'] : null,
      params != null && params.containsKey('sortText')
          ? params['sortText']
          : null,
      params != null && params.containsKey('textEdit')
...
class CompletionItemCapabilities {
  ...
  factory CompletionItemCapabilities.fromJson(Map params) =>
      new CompletionItemCapabilities._(
          params != null && params.containsKey('snippetSupport')
...
class CompletionList {
  ...
  factory CompletionList.fromJson(Map params) => new CompletionList._(
      params != null && params.containsKey('isIncomplete')
          ? params['isIncomplete']
          : null,
      params != null && params.containsKey('items')
...
class CompletionOptions {
  ...
  factory CompletionOptions.fromJson(Map params) => new CompletionOptions._(
      params != null && params.containsKey('resolveProvider')
          ? params['resolveProvider']
          : null,
      params != null && params.containsKey('triggerCharacters')
...
class Diagnostic {
  ...
  factory Diagnostic.fromJson(Map params) => new Diagnostic._(
      params != null && params.containsKey('code') ? params['code'] : null,
      params != null && params.containsKey('message')
          ? params['message']
          : null,
      params != null && params.containsKey('range')
          ? new Range.fromJson(params['range'])
          : null,
      params != null && params.containsKey('severity')
          ? params['severity']
          : null,
      params != null && params.containsKey('source') ? params['source'] : null);
  ...
  factory Diagnostics.fromJson(Map params) => new Diagnostics._(
      params != null && params.containsKey('diagnostics')
          ? params['diagnostics']
              ...
              .toList()
          : null,
      params != null && params.containsKey('uri') ? params['uri'] : null);
...
class DocumentOnTypeFormattingOptions {
  ...
  factory DocumentOnTypeFormattingOptions.fromJson(Map params) =>
      new DocumentOnTypeFormattingOptions._(
          params != null && params.containsKey('firstTriggerCharacter')
              ? params['firstTriggerCharacter']
              : null,
          params != null && params.containsKey('moreTriggerCharacter')
...
class ExecuteCommandOptions {
  ...
  factory ExecuteCommandOptions.fromJson(Map params) =>
      new ExecuteCommandOptions._(params != null &&
...
class Hover {
  ...
  factory Hover.fromJson(Map params) => new Hover._(
      params != null && params.containsKey('contents')
          ? params['contents']
          : null,
      params != null && params.containsKey('range')
          ? new Range.fromJson(params['range'])
...
class Position {
  ...
  factory Position.fromJson(Map params) => new Position._(
      params != null && params.containsKey('character')
          ? params['character']
          : null,
      params != null && params.containsKey('line') ? params['line'] : null);
...
class Range {
  ...
  factory Range.fromJson(Map params) => new Range._(
      params != null && params.containsKey('end')
          ? new Position.fromJson(params['end'])
          : null,
      params != null && params.containsKey('start')
...
class ReferenceContext {
  ...
  factory ReferenceContext.fromJson(Map params) => new ReferenceContext._(
      params != null && params.containsKey('includeDeclaration')
...
class SaveOptions {
  ...
  factory SaveOptions.fromJson(Map params) =>
      new SaveOptions._(params != null && params.containsKey('includeText')
          ? params['includeText']
          : null);
...
class ServerCapabilities {
  ...
  factory ServerCapabilities.fromJson(Map params) => new ServerCapabilities._(
      params != null && params.containsKey('codeActionProvider')
          ? params['codeActionProvider']
          : null,
      params != null && params.containsKey('codeLensProvider')
          ? params['codeLensProvider']
          : null,
      params != null && params.containsKey('completionProvider')
          ? new CompletionOptions.fromJson(params['completionProvider'])
          : null,
      params != null && params.containsKey('definitionProvider')
          ? params['definitionProvider']
          : null,
      params != null && params.containsKey('documentFormattingProvider')
          ? params['documentFormattingProvider']
          : null,
      params != null && params.containsKey('documentHighlightsProvider')
          ? params['documentHighlightsProvider']
          : null,
      params != null && params.containsKey('documentLinkProvider')
          ? new DocumentLinkOptions.fromJson(params['documentLinkProvider'])
          : null,
      params != null && params.containsKey('documentOnTypeFormattingProvider')
          ? params['documentOnTypeFormattingProvider']
          : null,
      params != null && params.containsKey('documentRangeFormattingProvider')
          ? params['documentRangeFormattingProvider']
          : null,
      params != null && params.containsKey('documentSymbolProvider')
          ? params['documentSymbolProvider']
          : null,
      params != null && params.containsKey('executeCommandProvider')
          ? new ExecuteCommandOptions.fromJson(params['executeCommandProvider'])
          : null,
      params != null && params.containsKey('hoverProvider')
          ? params['hoverProvider']
          : null,
      params != null && params.containsKey('referencesProvider')
          ? params['referencesProvider']
          : null,
      params != null && params.containsKey('renameProvider')
          ? params['renameProvider']
          : null,
      params != null && params.containsKey('signatureHelpProvider')
          ? new SignatureHelpOptions.fromJson(params['signatureHelpProvider'])
          : null,
      params != null && params.containsKey('textDocumentSync')
          ? new TextDocumentSyncOptions.fromJson(params['textDocumentSync'])
          : null,
      params != null && params.containsKey('workspaceSymbolProvider')
...
class SynchronizationCapabilities {
  ...
  factory SynchronizationCapabilities.fromJson(
      ...
      new SynchronizationCapabilities._(
          params != null && params.containsKey('didSave')
              ? params['didSave']
              : null,
          params != null && params.containsKey('dynamicRegistration')
              ? params['dynamicRegistration']
              : null,
          params != null && params.containsKey('willSave')
              ? params['willSave']
              : null,
          params != null && params.containsKey('willSaveWaitUntil')
  ...
  factory TextDocumentContentChangeEvent.fromJson(Map params) =>
      new TextDocumentContentChangeEvent._(
          params != null && params.containsKey('range')
              ? new Range.fromJson(params['range'])
              : null,
          params != null && params.containsKey('rangeLength')
              ? params['rangeLength']
              : null,
          params != null && params.containsKey('text') ? params['text'] : null);
...
class TextDocumentItem {
  ...
  factory TextDocumentItem.fromJson(Map params) => new TextDocumentItem._(
      params != null && params.containsKey('languageId')
          ? params['languageId']
          : null,
      params != null && params.containsKey('text') ? params['text'] : null,
      params != null && params.containsKey('uri') ? params['uri'] : null,
      params != null && params.containsKey('version')
          ? params['version']
          : null);
...
class TextDocumentSyncOptions {
  ...
  factory TextDocumentSyncOptions.fromJson(
      ...
      new TextDocumentSyncOptions._(
          params != null && params.containsKey('change')
              ? new TextDocumentSyncKind.fromJson(params['change'])
              : null,
          params != null && params.containsKey('openClose')
              ? params['openClose']
              : null,
          params != null && params.containsKey('save') ? params['save'] : null,
          params != null && params.containsKey('willSave')
              ? params['willSave']
              : null,
          params != null && params.containsKey('willSaveWaitUntil')
...
class TextEdit {
  ...
  factory TextEdit.fromJson(Map params) => new TextEdit._(
      params != null && params.containsKey('newText')
          ? params['newText']
          : null,
      params != null && params.containsKey('range')
          ? new Range.fromJson(params['range'])
...
class WorkspaceClientCapabilities {
  ...
  factory WorkspaceClientCapabilities.fromJson(
      ...
      new WorkspaceClientCapabilities._(
          params != null && params.containsKey('applyEdit')
              ? params['applyEdit']
              : null,
          params != null && params.containsKey('didChangeConfiguration')
              ? new DynamicRegistrationCapability.fromJson(
                  params['didChangeConfiguration'])
              : null,
          params != null && params.containsKey('didChangeWatchedFiles')
              ? new DynamicRegistrationCapability.fromJson(
                  params['didChangeWatchedFiles'])
              : null,
          params != null && params.containsKey('executeCommand')
              ? new DynamicRegistrationCapability.fromJson(
                  params['executeCommand'])
              : null,
          params != null && params.containsKey('symbol')
...
class WorkspaceEdit {
  ...
  factory WorkspaceEdit.fromJson(Map params) =>
      new WorkspaceEdit._(params != null && params.containsKey('changes')
